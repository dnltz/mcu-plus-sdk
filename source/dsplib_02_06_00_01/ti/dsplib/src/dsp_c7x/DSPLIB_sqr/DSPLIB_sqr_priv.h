 ...
 */
typedef DSPLIB_STATUS  (*pFxnDSPLIB_sqr_exec)(
...
extern DSPLIB_STATUS DSPLIB_sqr_init_ci(
                     DSPLIB_kernelHandle handle,
...
extern DSPLIB_STATUS DSPLIB_sqr_exec_ci(DSPLIB_kernelHandle handle,
                                        void *restrict pIn,
                                        void *restrict pOut);
 ...
 */
template <typename dataType, int32_t dataIn>
extern DSPLIB_STATUS DSPLIB_sqr_exec_cn(DSPLIB_kernelHandle handle,
                                        void *restrict pIn,
                                        void *restrict pOut);
 ...
 *
 */
DSPLIB_STATUS DSPLIB_sqr_init_cn(
              DSPLIB_kernelHandle handle,
