...
DSPLIB_STATUS DSPLIB_fir_init_cn(
                                                 ...
                                                 void *restrict pOut)
{
   ...
   printf("Enter DSPLIB_fir_exec_cn\n");
    ...
    DSPLIB_fir_PrivArgs *pKerPrivArgs =
        (DSPLIB_fir_PrivArgs *)handle;
...
#if DSPLIB_DEBUGPRINT
//            printf("DSPLIB_DEBUGPRINT l %d  dataOffset %d filterCtr %d dataBufferInPitch %d dataBufferOutPitch %d\n", l, dataOffset, filterCtr, dataBufferInPitch, dataBufferOutPitch);
//            printf("DSPLIB_DEBUGPRINT pInLocal: %f, pFilterLocal[k]: %f, dataSize: %d outTemp: %f outProd %f j %d k %d\n", pInLocal[dataOffset + filterCtr], pFilterLocal[k], dataSize, outTemp, outProd, j, k);
#endif
            filterCtr++;
         }
         pOutLocal[dataOffsetOut] = outTemp;
#if DSPLIB_DEBUGPRINT
//       printf("DSPLIB_DEBUGPRINT outTemp: %f, filterSize: %d, dataSize: %d batchSize: %d j %d k %d\n", outTemp, filterSize, dataSize, batchSize, j, k);
#endif
       }
   }
...
template DSPLIB_STATUS
         DSPLIB_fir_exec_cn<int16_t, int64_t>
                                            (DSPLIB_kernelHandle handle,
                                            void *restrict pIn,
                                            void *restrict pFilter,
                                            void *restrict pOut);
...
template DSPLIB_STATUS
         DSPLIB_fir_exec_cn<int32_t, DSPLIB_int128_t>
                                            (DSPLIB_kernelHandle handle,
                                            void *restrict pIn,
                                            void *restrict pFilter,
                                            void *restrict pOut);
...
template DSPLIB_STATUS
         DSPLIB_fir_exec_cn<int8_t, int32_t>
                                            (DSPLIB_kernelHandle handle,
                                            void *restrict pIn,
                                            void *restrict pFilter,
                                            void *restrict pOut);
template DSPLIB_STATUS
         DSPLIB_fir_exec_cn<float, int32_t>
                                            (DSPLIB_kernelHandle handle,
                                            void *restrict pIn,
                                            void *restrict pFilter,
                                            void *restrict pOut);
