 ...
 */
typedef DSPLIB_STATUS  (*pFxnDSPLIB_sub_exec)(
...
extern DSPLIB_STATUS DSPLIB_sub_init_ci(
                     DSPLIB_kernelHandle handle,
 ...
 */
template <typename dataType>
extern DSPLIB_STATUS DSPLIB_sub_exec_ci(DSPLIB_kernelHandle handle,
                                        void *restrict pIn1,
                                        void *restrict pIn2,
                                        void *restrict pOut);
 ...
 */
template <typename dataType>
extern DSPLIB_STATUS DSPLIB_sub_exec_cn(DSPLIB_kernelHandle handle,
                                        void *restrict pIn1,
                                        void *restrict pIn2,
                                        void *restrict pOut);
 ...
 *
 */
DSPLIB_STATUS DSPLIB_sub_init_cn(
              DSPLIB_kernelHandle handle,
