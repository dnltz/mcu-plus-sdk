 ...
 */
typedef DSPLIB_STATUS  (*pFxnDSPLIB_max_exec)(
...
extern DSPLIB_STATUS DSPLIB_max_init_ci(
                     DSPLIB_kernelHandle handle,
...
extern DSPLIB_STATUS DSPLIB_max_exec_ci(DSPLIB_kernelHandle handle,
                                        void *restrict pIn1,
                                        void *restrict pIn2,
                                        void *restrict pOut);
 ...
 */
template <typename dataType, int32_t dataIn>
extern DSPLIB_STATUS DSPLIB_maxint_exec_ci(DSPLIB_kernelHandle handle,
                                           void *restrict pIn1,
                                           void *restrict pIn2,
                                           void *restrict pOut);
/*!
 ...
 */
template <typename dataType, int32_t dataIn>
extern DSPLIB_STATUS DSPLIB_max_exec_cn(DSPLIB_kernelHandle handle,
                                        void *restrict pIn1,
                                        void *restrict pIn2,
                                        void *restrict pOut);
 ...
 *
 */
DSPLIB_STATUS DSPLIB_max_init_cn(
              DSPLIB_kernelHandle handle,
