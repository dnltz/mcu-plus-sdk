...
#if DSPLIB_DEBUGPRINT
//      if (samp == 0) {
//          printf("DSPLIB_DEBUGPRINT samp %d: vd0 %f vd1 %f vd2 %f vd3 %f vd4 %f vd5 %f\n", samp, vd0, vd1, vd2, vd3, vd4, vd5);
//          printf("DSPLIB_DEBUGPRINT samp %d: t1 %f t0 %f t3 %f t2 %f t5 %f t4 %f\n", samp, t1, t0, t3, t2, t5, t4);
//      }
#endif
...
#if DSPLIB_DEBUGPRINT
//         if (samp == 0)
            printf("DSPLIB_DEBUGPRINT numCh %d samp %d input1 %f output01 %f output02 %f output03 %f output07 %f output %f outGain %f pInLocal %p pOutLocal %p pOutLocal %f dataBufferOutPitch %d\n",
                   numCh, samp, input1, output01, output02, output03, output07, output, outGain, pInLocal, pOutLocal, *(dataType *)pOutLocal, dataBufferOutPitch);
#endif
      }
