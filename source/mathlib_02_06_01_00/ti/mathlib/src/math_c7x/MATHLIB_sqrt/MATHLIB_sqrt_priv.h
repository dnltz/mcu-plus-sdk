...
/********************************************************************************
  *  @file     MATHLIB_sqrt_priv.h
  *
  *  @brief    File to hold private parameter of function MATHLIB_sqrt
  *
  *  @version  0.1 - Mar 2022 : Initial Version
  *            
 ********************************************************************************/

#ifndef MATHLIB_SQRT_IXX_IXX_OXX_PRIV_H_
#define MATHLIB_SQRT_IXX_IXX_OXX_PRIV_H_

#include "../../common/MATHLIB_utility.h"
#include "MATHLIB_sqrt.h"

/*!
 * \file
 * \brief Header file for kernel's internal use. For the kernel's interface, please 
 *        see @ref MATHLIB_sqrt
 */

/*! 
 * @brief Macro to define the size of bufPblock array of 
 *        @ref MATHLIB_sqrt_PrivArgs structure.
 *
 */

/*!
 *  @brief This is a function pointer type that conforms to the 
 *         declaration of @ref MATHLIB_sqrt_exec_ci
 *         and @ref MATHLIB_sqrt_exec_cn.
 */
typedef MATHLIB_STATUS  (*pFxnMATHLIB_sqrt_exec)(
  void *restrict pIn,
  void *restrict pOut,
  int32_t blockSize);
 ...
 *         to the declaration of @ref MATHLIB_sqrt_init.
 *
 * @details This function determines the configuration for the streaming engine
 *          and MMA hardware resources based on the function call parameters, 
 *          and the configuration is saved in bufPBlock array. In the kernel
 *          call sequence, @ref MATHLIB_sqrt_exec_ci would be
 *          called later independently by the application. When 
 *          @ref MATHLIB_sqrt_exec_ci runs, it merely retrieves
 *          the configuration from the bufPBlock and uses it to set up the 
 *          hardware resources. This arrangement is so that 
 *          @ref MATHLIB_sqrt_exec_ci does not lose cycles
...
extern MATHLIB_STATUS MATHLIB_sqrt_exec_ci(void *restrict pIn,
                                            void *restrict pOut,
                                            int32_t blockSize);
...
extern MATHLIB_STATUS MATHLIB_sqrt_exec_cn(void *restrict pIn,
                                            void *restrict pOut,
                                            int32_t blockSize);
...
typedef struct
{
    ...
    *         @ref MATHLIB_sqrt_exec_cn and
    *         @ref MATHLIB_sqrt_exec_ci.                        */
   pFxnMATHLIB_sqrt_exec execute;
   /*! @brief Size of input buffer for different batches
    *         @ref MATHLIB_sqrt_init that will be retrieved
    *         and used by @ref MATHLIB_sqrt_exec                */
   int32_t blockSize;
} MATHLIB_sqrt_PrivArgs;
 ...
 *
 */
MATHLIB_STATUS MATHLIB_sqrt_init_cn(
              MATHLIB_kernelHandle handle,
              MATHLIB_bufParams2D_t *bufParamsIn,
              MATHLIB_bufParams2D_t *bufParamsOut);

#endif /* MATHLIB_SQRT_IXX_IXX_OXX_PRIV_H_ */

/* ======================================================================== */
/*  End of file:  MATHLIB_sqrt.h          */
/* ======================================================================== */
