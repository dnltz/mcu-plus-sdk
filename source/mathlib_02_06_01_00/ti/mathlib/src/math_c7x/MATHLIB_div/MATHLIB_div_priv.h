...
/********************************************************************************
  *  @file     MATHLIB_div_priv.h
  *
  *  @brief    File to hold private parameter of function MATHLIB_div
  *
  *  @version  0.1 - Mar 2022 : Initial Version
  *            
 ********************************************************************************/

#ifndef MATHLIB_DIV_IXX_IXX_OXX_PRIV_H_
#define MATHLIB_DIV_IXX_IXX_OXX_PRIV_H_

#include "../../common/MATHLIB_utility.h"
#include "MATHLIB_div.h"
 ...
 *        @ref MATHLIB_div_PrivArgs structure.
 *
 */

/*!
 *  @brief This is a function pointer type that conforms to the 
 *         declaration of @ref MATHLIB_div_exec_ci
 *         and @ref MATHLIB_div_exec_cn.
 */
typedef MATHLIB_STATUS  (*pFxnMATHLIB_div_exec)(
  void *restrict pIn,
  void *restrict pOut,
  int32_t blockSize);
 ...
 *         to the declaration of @ref MATHLIB_div_init.
 *
 * @details This function determines the configuration for the streaming engine
 *          and MMA hardware resources based on the function call parameters, 
 *          and the configuration is saved in bufPBlock array. In the kernel
 *          call sequence, @ref MATHLIB_div_exec_ci would be
 *          called later independently by the application. When 
 *          @ref MATHLIB_div_exec_ci runs, it merely retrieves
 *          the configuration from the bufPBlock and uses it to set up the 
 *          hardware resources. This arrangement is so that 
 *          @ref MATHLIB_div_exec_ci does not lose cycles
...
extern MATHLIB_STATUS MATHLIB_div_exec_ci(void *restrict pIn,
                                            void *restrict pOut,
                                            int32_t blockSize);
...
extern MATHLIB_STATUS MATHLIB_div_exec_cn(void *restrict pIn,
                                            void *restrict pOut,
                                            int32_t blockSize);
...
typedef struct
{
    ...
    *         @ref MATHLIB_div_exec_cn and
    *         @ref MATHLIB_div_exec_ci.                        */
   pFxnMATHLIB_div_exec execute;
   /*! @brief Size of input buffer for different batches
    *         @ref MATHLIB_div_init that will be retrieved
    *         and used by @ref MATHLIB_div_exec                */
   int32_t blockSize;
} MATHLIB_div_PrivArgs;
 ...
 *
 */
MATHLIB_STATUS MATHLIB_div_init_cn(
              MATHLIB_kernelHandle handle,
              MATHLIB_bufParams2D_t *bufParamsIn,
              MATHLIB_bufParams2D_t *bufParamsOut);

#endif /* MATHLIB_DIV_IXX_IXX_OXX_PRIV_H_ */

/* ======================================================================== */
/*  End of file:  MATHLIB_div.h          */
/* ======================================================================== */
